...
public class EditPitchActivity extends Activity {
    ...
    void selectMultipleImg() {
        ...
        if ((ActivityCompat.checkSelfPermission(EditPitchActivity.this,
                ...
                (ActivityCompat.checkSelfPermission(EditPitchActivity.this,
                        Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)) {
            ActivityCompat.requestPermissions(EditPitchActivity.this, new String[]
    ...
    private void setlisteners() {
        if (etfname.length() == 0 || etfname.getText().toString().trim().length() == 0) {
            Toast.makeText(EditPitchActivity.this, getResources().getString(R.string.plzEnterpitchname), Toast.LENGTH_SHORT).show();
        } else if (etdescriptn.length() == 0 || etdescriptn.getText().toString().trim().length() == 0) {
            Toast.makeText(EditPitchActivity.this, getResources().getString(R.string.plzEnterdescption), Toast.LENGTH_SHORT).show();
        } else if (etprice.length() == 0 || etprice.getText().toString().trim().length() == 0) {
            Toast.makeText(EditPitchActivity.this, getResources().getString(R.string.enterprice), Toast.LENGTH_SHORT).show();
...
//
//            Call<ResponseBody> call = service.editPitch(
//                    multipart_body,
...
//                                getAvailbilityData(jsonpitch_availability);
//
//                                /*pitch Images*/
...
//        });
    ...
    private void getAvailbilityData(JSONObject jsonObject) {
        try {
            if (jsonObject.getString("day_monday").equals("1")) {
                chkboxmonday.setChecked(true);

            } else {
                chkboxmonday.setChecked(false);

            }
            mondayST.setText(jsonObject.getString("monday_start"));
            mondayET.setText(jsonObject.getString("monday_end"));

            /*////////day_tusday////*/
            if (jsonObject.getString("day_tusday").equals("1")) {
                chkboxtuesday.setChecked(true);

            } else {
                chkboxtuesday.setChecked(false);

            }
            tuesdayST.setText(jsonObject.getString("tusday_start"));
            tuesdayET.setText(jsonObject.getString("tusday_end"));
            /*//////////////////*/


            if (jsonObject.getString("day_wednesday").equals("1")) {
                chkboxwednsday.setChecked(true);

            } else {
                chkboxwednsday.setChecked(false);

            }
            wednsdayST.setText(jsonObject.getString("wednesday_start"));
            wednsdyET.setText(jsonObject.getString("wednesday_end"));
            /*/////////////////*/
            if (jsonObject.getString("day_thursday").equals("1")) {
                chkboxthursday.setChecked(true);

            } else {
                chkboxthursday.setChecked(false);

            }
            thursdayST.setText(jsonObject.getString("thursday_start"));
            thursdayET.setText(jsonObject.getString("thursday_end"));
            /*////////////////////*/
            if (jsonObject.getString("day_friday").equals("1")) {
                chkboxfriday.setChecked(true);

            } else {
                chkboxfriday.setChecked(false);

            }
            fridayST.setText(jsonObject.getString("friday_start"));
            fridayEt.setText(jsonObject.getString("friday_end"));
            /*/////////////////*/
            if (jsonObject.getString("day_saturday").equals("1")) {
                chkboxsaturday.setChecked(true);

            } else {
                chkboxsaturday.setChecked(false);

            }
            saturdayST.setText(jsonObject.getString("saturday_start"));
            saturdayET.setText(jsonObject.getString("saturday_end"));
            /*////////////////////*/
            if (jsonObject.getString("day_sunday").equals("1")) {
                chkboxsunday.setChecked(true);

            } else {
                chkboxsunday.setChecked(false);

            }
            sundayST.setText(jsonObject.getString("sunday_start"));
            sundayET.setText(jsonObject.getString("sundayy_end"));
